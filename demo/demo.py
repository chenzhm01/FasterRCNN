...
from utils import step2_result_nms, draw_image, gamma_trans

box_pb_path='/media/commaai02/disk_1TB/every_stop/box/code/every_faster_768.pb-30000'
cls_pb_path='/media/commaai02/disk_1TB/huapu600/output_0824_vgg19/vgg19_model.pb-401137'
...
def main():
    ...
    cap.set(3,800)
    cap.set(4,600)
    imagedir_for_test = '/media/commaai02/disk_1TB/every_stop/20180813everystop'
    ...
    #while(1):
        ...
        cv2.imwrite('/media/commaai02/disk_1TB/every_stop/p1/'+imagelist[step], detect_dict['image_bgr'])
